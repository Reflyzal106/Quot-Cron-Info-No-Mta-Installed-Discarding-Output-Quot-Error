# [SOLVED] Quot-Cron-Info-No-Mta-Installed-Discarding-Output-Quot-Error
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/quot-cron-info-no-mta-installed-discarding-output-quot-error)
>
...
Check the cron daemon's configuration to ensure it is not running with excessive privileges or consuming unnecessary resources.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/quot-cron-info-no-mta-installed-discarding-output-quot-error)**
